...
export const Route = createFileRoute("/services/modular-kitchen")({
  head: () => ({
    meta: [
      { title: "Modular Kitchen in India | Sky Nest Constructions" },
      { name: "description", content: "Premium modular kitchen design and installation across India. Get a free consultation, 3D design preview, and transparent pricing." },
    ],
...
function Component() {
  return (
    <SiteLayout>
      <SeoPageLayout
        title="Modular Kitchen in India"
        description="Sky Nest Constructions designs and installs modular kitchens across India with premium finishes, efficient storage, and seamless execution."
        h1="Modular Kitchen in India"
        ...
        faqs={[
          { question: "What is the price of a modular kitchen in India?", answer: "Prices vary by size, finish and accessories. A standard kitchen can start from around ₹1.5 lakhs, while premium layouts can go higher. We provide a transparent quote after consultation." },
      ...
      >
        <p className="mt-6 text-base text-muted-foreground">
          Whether you want a compact kitchen for a city apartment or a luxurious full-height kitchen for a villa, our team balances elegance, durability and practical workflow. We specialise in modular kitchens for homes, villas and premium apartments across India.
        </p>
      </SeoPageLayout>
    </SiteLayout>
  );
