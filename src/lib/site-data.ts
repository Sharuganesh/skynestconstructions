...
export const services: Service[] = [
  ...
  { slug: "tv-unit", title: "TV Unit Design", icon: Tv, blurb: "Statement media walls and feature units that blend utility, acoustics and visual impact seamlessly.", image: "https://images.unsplash.com/photo-1615873968403-89e068629265?auto=format&fit=crop&w=1200&q=70" },
  ...
  { slug: "bedroom", title: "Bedroom Interiors", icon: Bed, blurb: "Calm, premium bedrooms with layered lighting, concealed storage and refined material palettes.", image: "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=1200&q=70" },
  ...
  { slug: "pvc", title: "PVC Interiors", icon: Box, blurb: "Moisture-resistant PVC wall and ceiling solutions for clean, long-lasting interiors with low maintenance.", image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1200&q=70" },
  { slug: "wood-works", title: "Wood Works", icon: Hammer, blurb: "Precision carpentry, joinery and custom millwork with careful detailing and premium finishing.", image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=1200&q=70" },
  { slug: "wallpaper", title: "Wallpaper Installation", icon: ImageIcon, blurb: "Expert wallpaper application for feature walls and complete spaces with a smooth, flawless finish.", image: "https://images.unsplash.com/photo-1615874959474-d609969a20ed?auto=format&fit=crop&w=1200&q=70" },
  { slug: "3d-design", title: "3D Design", icon: Boxes, blurb: "Photo-realistic 3D visualisation so you can review the design, materials and layout before execution.", image: "https://images.unsplash.com/photo-1545972154-9bb223aac798?auto=format&fit=crop&w=1200&q=70" },
  ...
  { slug: "electrical", title: "Electrical Works", icon: Zap, blurb: "Safe, efficient electrical planning and installation for homes and commercial interiors.", image: "https://images.unsplash.com/photo-1565608438257-fac3c27beb36?auto=format&fit=crop&w=1200&q=70" },
  { slug: "plumbing", title: "Plumbing Works", icon: Droplets, blurb: "Reliable concealed plumbing solutions designed for longevity, hygiene and leak-free performance.", image: "https://images.unsplash.com/photo-1542013936693-884638332954?auto=format&fit=crop&w=1200&q=70" },
