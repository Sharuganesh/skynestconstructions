    ...
    <footer className="relative mt-20 overflow-hidden bg-primary-deep text-primary-foreground">
      ...
      <div className="relative mx-auto max-w-7xl px-5 py-16 lg:px-8">
        ...
        <div className="mt-12 border-t border-white/15 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/60">
          ...
          <p>Interior Design & Construction · India-wide · 16+ years expertise</p>
        </div>

        <div className="mt-4 border-t border-white/10 pt-4 text-[11px] text-white/40 text-center leading-relaxed">
          Sky Nest Constructions — Interior Designer & Construction Company serving homes, villas and offices across India.
          Serving All Over India with certified engineering support, complete plan approval assistance and turnkey execution.
